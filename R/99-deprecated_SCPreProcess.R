...
#'
#' @description
#' `r lifecycle::badge('deprecated')` A unified interface for standardized single-cell RNA-seq preprocessing.
...
SCPreProcess <- function(sc, ...) {
  lifecycle::deprecate_warn(
    "4.0.0",
    "SCPreProcess()",
    details = "`SCPreProcess()` has been deprecated due to extra call overhead,\
     bloated functionality, and inflexible parameter control. 
     Consider using package `scCustomize` and Seurat pipeline as an alternative."
  )

...
#> 
#>   Yang Y, Wang S (2026). _SigBridgeR: Integrative Toolkit for Linking Phenotypes to Cell Subpopulations via
#>   scRNA-seq and Bulk Data_. R package version 4.0.0, <https://wanglabcsu.github.io/sigbridger>.
#> 

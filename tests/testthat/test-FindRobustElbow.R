test_that("FindRobustElbow works", {
  # 生成单细胞表达原始矩阵模拟数据的函数
  # 1. 设置随机种子以保证结果可重复
  set.seed(42)
  ...
  counts <- vroom::vroom("/data/home/yyx/Data/DEGAS/scDat.csv")
  counts <- tibble::column_to_rownames(counts, "...1")
  ...
  ndims <- SigBridgeR::FindRobustElbow(seurat)
})

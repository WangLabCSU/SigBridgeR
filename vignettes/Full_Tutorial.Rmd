...
Environment configuration has been replaced by `reticulate::use_*`, which is more flexible and easier to use. So conda environments are no longer created by `SigBridgeR:::SIDISHEnvSet()`, left here for reference:

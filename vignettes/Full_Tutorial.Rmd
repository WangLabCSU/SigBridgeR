...
```{r}
#| include: false
bulk <- readRDS(system.file(
  "extdata",
  "binary_example_data.rds",
  package = "SigBridgeR"
))[[2]]
```
...
To obtain a template python env for DEGAS, you can use:
...
#| eval: false
degas_param <- DEGASParamSet(list())

env_param <- DEGASEnvSet(list())
```

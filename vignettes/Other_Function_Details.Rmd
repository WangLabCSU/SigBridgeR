...
```{r,optimal_normalization,eval=FALSE}
...
```{r,add_meta_feature_example,eval=FALSE}
...
```{r,add_meta_feature_example_2,eval=FALSE}
...
```{r,add_meta_feature_example_3,eval=FALSE}
...
```{r,matrix_integration_example,eval=FALSE}
...
```{r,head_integrated_mat,eval=FALSE}
...
```{r,seurat_integration_example,eval=FALSE}
...
```{r,seurat_integration_example_2,eval=FALSE}
mat1 <- matrix(
  rpois(1000, 5),
  nrow = 20,
...
```{r,head_integrated_seu,eval=FALSE}
integrated_seu
...
```{r,cell_type_annotation_example,eval=FALSE}
seurat <- SCAnnotate(
  sc = seurat,
...
```{r,cell_typist_annotation_example_2,eval=FALSE}
...
```{r,mLLMCelltype_annotation_example,eval=FALSE}
...
```{r,singleR_annotation_example,eval=FALSE}
...
```{r,get_var_value_example,eval=FALSE}
g <- function(a = 1, b = 2) {
  c <<- a * 2 + b * 3
  d = c^2
  e <- d - 1
...
```{r,usethis_use_standalone_example,eval=FALSE}

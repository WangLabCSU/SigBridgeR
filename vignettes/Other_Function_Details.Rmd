...
Used to control the number of threads for OpenMP and data.table. By default, uses half of the maximum available threads.

Default:

```{r,set_threads_example,eval=FALSE}
setThreads(
  n_threads = NULL,
  backend = c("openmp", "dt")
)
...
```{r,set_threads_example_2,eval=FALSE}
setThreads(1L)
```

```{r,set_threads_example_3,eval=FALSE}

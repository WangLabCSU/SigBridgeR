...
The corresponding TCGA survival data can be obtained from **UCSC Xena (via UCSCXenaShiny)**.
...
A new file named `Scissor_inputs.RData` will be created, which contains the input data for the Scissor algorithm. You can use the intermediate data for repeated runs. This is an inherent feature of the `Scissor`.

A new column named `Scissor` will be added to the `meta.data` of the Seurat object, with three possible labels: **Positive**, **Negative**, and **Neutral**. **Positive** denotes cells associated with **poor survival prognosis**.

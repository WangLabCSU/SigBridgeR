...
```{r,restart_R,eval=FALSE}
# restart R/RStudio
.rs.api.restartSession()
```

```{r,clean_all,eval=FALSE}
...
>
>  **File "/home/user/R/Project/R_code/SigBridgeR/Tmp/tmp/BlankClassMTL.py", line 1, in <module>**
>
